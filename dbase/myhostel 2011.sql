...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 20, 2018 at 05:54 PM
...
INSERT INTO `register` (`reg_no`, `name`, `password`, `type`, `category`, `address`, `allot_no`, `status`, `date`, `phone`, `class`, `batch`, `email`, `hostel_name`, `gender`) VALUES
(10, 'admin', 'admin', NULL, '', NULL, NULL, 0, '2018-10-29 02:50:47', 9961430436, 'MCA', 2016, NULL, 'PGH', NULL),
(12, 'sajai', 'aaaa', NULL, NULL, NULL, NULL, 1, '2018-10-29 03:04:37', 9961430436, 'B.arch', 2016, NULL, 'PGH', NULL),
(13, 'jasim', 'aaaaaa', NULL, NULL, NULL, NULL, 1, '2018-10-29 03:05:45', 9961430436, 'B.tech', 2017, NULL, 'NEWLH', NULL);
COMMIT;
