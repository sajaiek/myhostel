...
<tr><td>Amount</td><td><input type="text" name="psd"></td></tr>
<tr><td>Payment Type:</td><td><td><select>
  ...
  <tr><td>Transaction Number</td><td><input type="text" name="psd"></td></tr>
   ...
   <tr><td>Password</td><td><input type="password" name="psd"></td></tr>
     ...
     <tr><td><button type="button">Pay</button></td><td><button type="button" class="mt-5">Clear</button></td></tr>                  
     </table>
