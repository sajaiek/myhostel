 ...
 * @Last Modified time: 2018-11-21 05:53:26
 */
?>
<?php
if (session_status() === PHP_SESSION_NONE){session_start();}

define( 'SYSTEM_NAME', 'myhostel' ); 
define( 'DISPLAY_NAME', 'MY HOSTEL' );
define( 'SYSTEM_ROOT', '/myhostel' );
...
define( 'KEY', 'f4c6se34sff3s43DF45SEr2dsw4dfdtdte4q0ise3w5');
...
define( 'DIRECTORY_PUBLIC', DIRECTORY  . 'public' ); 
...
define( 'DIRECTORY_AUTHORITY', DIRECTORY . AUTHORITY . '/' ); 
define( 'DIRECTORY_INMATE', DIRECTORY . INMATE . '/' ); 




define( 'PATH_ADMIN', PATH . ADMIN );   
define( 'PATH_AUTHORITY', PATH . AUTHORITY );  
define( 'PATH_INMATE', PATH . INMATE );  
